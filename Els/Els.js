...
/**
 * @class
 * to generate a map of DOM-elements or/and Html objects generated by hierarchic id
...
class Els {
	...
	/**
	 * generate a snap-shot of the given Html object and save it hierarchically
	 * @param {Html} html the Html object to be added
	 * @param {...string|...number} keys set of keys to generate hierarchy
	 */
	addHtml(html, ...keys) {
		const keysFlat = flattenDeep([this.name,this.subKeys,keys])
		Obj.put(this.htmls, keysFlat, html)
	}
	/**
	...
	/**
	 * get Html-element in respect to the given object name, to abbreviate call
	 * @param {...string|...number} keys set of keys to generate hierarchy
	 * @returns {Html} the DOM-Element
	 */
	getHtml(...keys) {
		const keysFlat = flattenDeep([this.name,this.subKeys,keys])
		return Obj.get(this.htmls,keysFlat)
	}
}
export default Els